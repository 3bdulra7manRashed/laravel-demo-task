...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md mx-auto bg-white shadow-lg rounded-xl p-6">
        ...
        <form action="{{ route('dashboard.update', $item) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="flex gap-3 pt-4">
                <button type="submit" 
                        class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg transition duration-200">
                    Update Item
                </button>
